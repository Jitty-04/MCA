...
con=MySQLdb.connect("localhost","root","","cyberspy")
...
def Adminlogin(request):
    ...
    return render(request,"Adminlogin.html",{"data":msg})
...
def msg_reply(request):
    ...
    if(request.POST):
        ...
        s="insert into reply_table(`from`,`to`,`filename`,`file_type`,`date`,`message`) values('"+str(username)+"','"+str(to)+"','"+str(fileurl)+"','"+str(File_type)+"','"+str(now)+"','"+str(Message)+"')"
        c.execute(s)
        con.commit()
...
def feedback(request):
    ...
    if(request.POST):
        ...
        s="insert into feedback values('','"+str(Name_of_user)+"','"+str(Email)+"','"+str(Experience_with_app)+"','"+str(Rating)+"','"+str(Comments)+"')"
        c.execute(s)
        con.commit()
        print(s)
...
def sms_s(request):
    ...
    return render(request,"sms_s.html")
